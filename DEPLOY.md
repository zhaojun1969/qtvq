...
- 超出后需办理 **月卡 ¥29 / 季卡 ¥79 / 年卡 ¥299**（微信 Native 在线支付或对公汇款）；注册登录后可在 [我的账户](https://qtvq.cn/account.html) 查看核实进度。
- PC 支持 **微信扫码登录**（开放平台网站应用，回调 `wechat-callback.html`），详见 [docs/WECHAT-OPEN-LOGIN.md](docs/WECHAT-OPEN-LOGIN.md)。
